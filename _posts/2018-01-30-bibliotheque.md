...
1. La symétrie des libertés : la garantie que personne n’est privilégiée par la définition d’une liberté donnée sur un objet particulier (l'accès, le logiciel, les ressources, la monnaie, le code social…)
