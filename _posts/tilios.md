...
Cet article est volontairement et clairement "Tiers", dans le sens où il s'attache à décrire une réalité complexe, transitoire et chaotique s'inscrivant dans le décalage croissant qui nait entre monde à partire et un monde à venir. Entre démarche de documentation, d'études, de recherches, et tentative de définition, cette production peut s'intégrer dans processus relatif à une approche participative de la recherche.
...
En conlusion de cet article, j'aimerais rappeler que le Tiers-lieux libre et open source était au départ un objet défini augmenté d'une idée abstraite inspirée du logiciel libre.
Dans cette origine, il peut être sujet à réification (du latin _res_, chose) en considérerant cette idée abstraite comme une chose concrète ou un objet tangible.
...
Dans le web sémantique, il peut y avoir des faits [web sémantique classique] mais aussi des faits rapportés depuis des points de vue spécifiques [web sémantique réifié] ([Reification (knowledge representation)](https://en.wikipedia.org/wiki/Reification_(knowledge_representation)), Le Tiers-Lieux libre et open source (dont l'origine est liée à celle de web par le logiciel libre) est capable, par ces commuanutés de pratiques comme par des universitaires, de forger des définitions pour une sémantique prenant coprs dans un troisième langage mais également hors de ce troisième langage. Il est capable de produire un code source avec démarche, qui pourrait être définie comme tiers-scientifique, de transparence et d’ouverture par la   publication de retours d’expériences aux fins de duplication avec un engagement de quallité éthique et technique.
